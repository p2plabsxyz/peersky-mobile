...
describe('browser downloads', () => {
  ...
  test('generates and registers the Android download bridge idempotently', () => {
    ...
    assert.match(webViewManagerSource, /native-long-click/)
    assert.match(webViewManagerSource, /native-dom-fallback/)
    assert.match(webViewManagerSource, /native-target-dispatched/)
    assert.match(webViewManagerSource, /peersky-browser-media-diagnostic/)
